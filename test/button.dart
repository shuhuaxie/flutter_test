...
import 'package:flutter/material.dart' hide PhysicalShape;
import '../lib/mock/material/material.dart';
import 'package:flutter/widgets.dart';
import 'package:flutter_test/flutter_test.dart';

import 'test_data/image_data.dart';
import 'test_data/mock_canvas.dart';
...
Future<void> main() async {
  ...
  testWidgets('DecoratedBox handles loading images',
    ...
    print('hasScheduledFrame:' + tester.binding.hasScheduledFrame.toString());
